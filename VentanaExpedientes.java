...
public class VentanaExpedientes extends javax.swing.JFrame {
    ...
    private void cargarTablaPendientes(){
        String[] columnas = {"ID", "Prioridad", "Nombre", "Apellidos", "Asunto", "Fecha"};
        ...
        for (int i = 0; i < pendientes.tamaño(); i++) {
            ...
            Interesado inter = e.getInteresado();
            String[] fila = {e.getId(), e.getPrioridad(), inter.getNombres(), inter.getApellidos(), e.getAsunto(), e.getFechaInicio().toString()};
            modelo.addRow(fila);                    
        }
